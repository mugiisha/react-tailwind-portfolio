      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2  leadin-8 text-gray-800 dark:text-gray-200">
            ...
            <p className="text-md py-2  leadin-8 text-gray-800 dark:text-gray-200">
              I offer from a wid range of services, including programming and
              teaching
            </p>
          </div>
          <div className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:text-gray-200">
